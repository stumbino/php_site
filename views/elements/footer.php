   <!-- Le javascript
    ...
    <script src="<?php echo BASE_URL?>views/js/validation/jquery.validate.js"></script>
    <script src="<?php echo BASE_URL?>views/js/validation/additional-methods.js"></script>
   <?php
   if($u->isAdmin()) {
       ?>
